...
namespace nanoFramework.Device.Bluetooth.Services
{
    ...
    {
        private const ushort PnPId = 0x2A50;
            ...
            )
        {
            ...
            // Set the Pnp elements
            DataWriter writer = new DataWriter();
            writer.WriteBuffer(new Buffer(pnp.Serialize()));
            _deviceInformationService.CreateCharacteristic(Utilities.CreateUuidFromShortCode(PnPId), new GattLocalCharacteristicParameters()
            {
